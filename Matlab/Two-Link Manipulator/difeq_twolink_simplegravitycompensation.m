function x_dot = difeq_twolink_simplegravitycompensation(t,x,m_1,m_2,I_1,I_2,l_1,l_2,l_c1,l_c2,g,q_1d,q_2d,Kp,Kv)
x_dot = zeros(4,1);
...
u_1 = Kp(1,1) * (q_1d - x(1)) + Kv(1,1) * (0 - x(2)) + (m_1 * l_c1 + m_2 * l_1) * g * cos(q_1d) + m_2 * l_c2 * g * cos(q_1d + q_2d);
u_2 = Kp(2,2) * (q_2d - x(3)) + Kv(2,2) * (0 - x(4)) + m_2 * l_c2 * g * cos(q_1d + q_2d);
