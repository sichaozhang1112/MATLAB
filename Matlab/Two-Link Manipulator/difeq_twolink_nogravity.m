function x_dot = difeq_twolink_nogravity(t,x,m_1,m_2,I_1,I_2,l_1,l_2,l_c1,l_c2,g,q_1d,q_2d,Kp,Kv)
x_dot = zeros(4,1);
...
% x_dot
x_dot(1) = x(2);
x_dot(2) = ((u_1 - c_11 * x(2) - c_12 * x(4)) * d_22 - (u_2 - c_21 * x(2)) * d_12)/(d_11 * d_22 - d_21 * d_12);
x_dot(3) = x(4);
x_dot(4) = ((u_1 - c_11 * x(2) - c_12 * x(4)) * d_21 - (u_2 - c_21 * x(2)) * d_11)/(d_12 * d_21 - d_22 * d_11);
